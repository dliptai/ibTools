...
extraGangliaMetrics = [ 'ib_bytes_in', 'ib_bytes_out', 'ib_pkts_in', 'ib_pkts_out',
                        'farnarkle_fred_mds_ops', 'farnarkle_fred_oss_ops', 'farnarkle_fred_read_bytes', 'farnarkle_fred_write_bytes',
                        'farnarkle_apps_mds_ops', 'farnarkle_apps_oss_ops', 'farnarkle_apps_read_bytes', 'farnarkle_apps_write_bytes',
                        'farnarkle_home_mds_ops', 'farnarkle_home_oss_ops', 'farnarkle_home_read_bytes', 'farnarkle_home_write_bytes',
                        'farnarkle_images_mds_ops', 'farnarkle_images_oss_ops', 'farnarkle_images_read_bytes', 'farnarkle_images_write_bytes',
...
metricMap = [ 'network', [ 'ib_bytes_in',    [ 'ib_bytes_in',  1 ],
                           'ib_bytes_out',   [ 'ib_bytes_out', 1 ],
                           'ib_packets_in',  [ 'ib_pkts_in',  1 ],
                           'ib_packets_out', [ 'ib_pkts_out', 1 ] ] ]
...
computeNodes = [ 'john[1-110]', 'bryan[1-8]', 'gina[1-4]', 'gstar[011-059,101-105,201-204]', 'sstar[011-032,101-167,301-301]', 'clarke[1-10]' ]
headNodes = [ 'farnarkle[1-2]', 'sstar', 'gstar', 'transom[1-2]', 'phlange', 'data-mover[01-04]', 'hpc-mgmt', 'tapeserv01' ]
ioNodes = [ 'lnet[01-10]', 'warble[1-2]', 'arkle[1-10]', 'umlaut[1-4]', 'metadata101', 'object[101-102]' ]
...
specialRows = [ [ ['login','head'], ['farnarkle[1-2]','node'], ['sstar','node'], ['gstar','node'], ['infra- structure','head'], ['transom[1-2]','node'], ['hpc-mgmt', 'node'], ['dm','head'], ['data-mover[01-04]','node'], ['misc', 'head'], ['phlange', 'node'], ['tapeserv01', 'node' ] ],
                [ ['router','head'], ['lnet[01-10]','node'], ],
                [ ['mds','head'], ['warble[1-2]','node'],  ['oss', 'head' ], ['arkle[1-10]','node'], ['umlaut[1-4]', 'node' ], ['mds','head'], ['metadata101','node'], ['oss', 'head'], ['object[101-102]','node' ] ] ]
...
racks = [ [22,'pizza'],[22,'pizza'],[22,'pizza'],[22,'pizza'],[22,'pizza'],[20,'pizza'],[25,'pizza'],[25,'pizza'],[25,'pizza'],[25,'pizza'],[25,'pizza'],[25,'pizza'],[10,'pizza'],['fe','pizza'] ]
